...
namespace _4.Sayfa
{
    ...
    {   //hesapla fonksiyonumuz için integer değişkenler oluşturduk
        //illerde kullandığımız değişkenler
        public int a;
        public int b;
        public int c;
        public int d;
        public int f;
        public int g;
        //ülkelerde kullandığımız değişkenler
        public int x;
        public int s;
        public int h;
        public int m;
        ...
        Atama atama = new restoranSehir();//polimorfizm kullandık
        Sepet sepet = new Sepet();
        Odeme odeme = new Odeme();
        restoranSehir isim = new restoranSehir();
        private void restoran_Load(object sender, EventArgs e)
        {
           
            Atama.kategori = "Restoran"; 

            this.AutoScroll = true; //ekran kaydırma
            this.MaximizeBox = false;//ekran ebatı

            //kullanıcının giriş yapıp yapmadığını belirtir.
            label82.Text = GırısAtama.kullanıcı;
            if ((label82.Text != GırısAtama.kullanıcı) || (GırısAtama.kullanıcı == "0"))
            {
            ...
            {
                label82.Text = "HOŞGELDİN " + GırısAtama.kullanıcı;
                label82.ForeColor = Color.SeaGreen;
            }

            //label isimleri atadık
            label53.Text = "Bütçe";
            ...
            //resimler picturebox içinde atandı
            ...
            panel7.Visible = true;
         //Restoran nesnesi oluşturuldu.
            restoranSehir restoran = new restoranSehir();
        //Basliga hangi sehirde olundugunu atar.
            label24.Text = Atama.isim;
       //seçilen şehirlere göre if ,else if döngüleri kullanarak bilgiler yazdırıldı
            ...
            //label değerleri toplanarak hesapla fonk. kullanacağımız değişkenlere atadık
            ...
            else if (Atama.isim == "Nevşehir")
            {
                // Ödeme bilgilerine eklemek için 
                // Atama classındaki parabirimi bilgisini ilettik.
                sepet.birim = atama.x;
                //Aynı şekilde parabirimi bilgisini alarak Formda gerekli yerlere yazdırdık.
                label83.Text = isim.x;
                label84.Text = isim.x;
                label85.Text = isim.x;
                label86.Text = isim.x;
                label87.Text = isim.x;
                label88.Text = isim.x;
                //görünmesini istemediğimiz label değerlerini visible false yaptık
                label89.Visible = false; label92.Visible = false;
                label90.Visible = false; label93.Visible = false;
                label91.Visible = false; label94.Visible = false;
               //Nevşehir'e ait restoranların resimleri alındı
                ...
                //1.restoranın ismi,resmi ve label değerleri atandı
                restoran.Yad = radioButton1.Text;
                ...
                restoran.Yaksmy = label6.Text;
                label6.Text = "200";
                //label değerlerine atadığımız sayıların toplamını sayıya çevirerek a değiskenine atadık
                a = Convert.ToInt32(label4.Text) + Convert.ToInt32(label6.Text);
                label68.Text = a.ToString();
                //görünmesini istemediğimiz label değerlerini visible false yaptık
                label1.Visible = false; label2.Visible = false; label9.Visible = false; label10.Visible = false;
                ...
                //2.restoranın ismi,resmi ve label değerleri atandı
                restoran.Yad = radioButton2.Text;
                ...
                restoran.Yaksmy = label15.Text;
                label15.Text = "150";
                //label değerlerine atadığımız sayıların toplamını sayıya çevirerek b değiskenine atadık
                b = Convert.ToInt32(label17.Text) + Convert.ToInt32(label15.Text);
                label71.Text = b.ToString();
                //görünmesini istemediğimiz label değerlerini visible false yaptık
                label12.Visible = false; label11.Visible = false; label13.Visible = false; label14.Visible = false;
                ...
                //3.restoranın ismi,resmi ve label değerleri atandı
                restoran.Yad = radioButton3.Text;
                ...
                restoran.Ytatlı = label23.Text;
                label23.Text = "25";
                //label değerlerine atadığımız sayıların toplamını sayıya çevirerek c değiskenine atadık
                c = Convert.ToInt32(label28.Text) + Convert.ToInt32(label26.Text) + Convert.ToInt32(label23.Text);
                label73.Text = c.ToString();
                //görünmesini istemediğimiz label değerlerini visible false yaptık
                label44.Visible = false; label22.Visible = false; label30.Visible = false;
                ...
                //4.restoranın ismi,resmi ve label değerleri atandı
                restoran.Yad = radioButton4.Text;
                ...
                restoran.Ytatlı = label34.Text;
                label34.Text = "25";
                //label değerlerine atadığımız sayıların toplamını sayıya çevirerek d değiskenine atadık
                d = Convert.ToInt32(label38.Text) + Convert.ToInt32(label36.Text) + Convert.ToInt32(label34.Text);
                label75.Text = d.ToString();
                //görünmesini istemediğimiz label değerlerini visible false yaptık
                ...
                //5.restoranın ismi,resmi ve label değerleri atandı
                restoran.Yad = radioButton5.Text;
                ...
                restoran.Yaksmy = label46.Text;
                label46.Text = "60";
                //label değerlerine atadığımız sayıların toplamını sayıya çevirerek f değiskenine atadık
                f = Convert.ToInt32(label48.Text) + Convert.ToInt32(label46.Text);
                label77.Text = f.ToString();
                //görünmesini istemediğimiz label değerlerini visible false yaptık
                label31.Visible = false; label30.Visible = false;
                ...
                //6.restoranın ismi,resmi ve label değerleri atandı
                restoran.Yad = radioButton6.Text;
                ...
                restoran.Yaksmy = label62.Text;
                label62.Text = "50";
                //label değerlerine atadığımız sayıların toplamını sayıya çevirerek g değiskenine atadık
                g = Convert.ToInt32(label66.Text) + Convert.ToInt32(label64.Text) + Convert.ToInt32(label62.Text);
                label79.Text = g.ToString();
                //görünmesini istemediğimiz label değerlerini visible false yaptık
            ...
            { // Ödeme bilgilerine eklemek için 
              // Atama classındaki parabirimi bilgisini ilettik.
                ...
                label81.Visible = true;
               //görünmesini istemediğimiz labellerı visible  false yaptık
                label83.Visible = false; label84.Visible = false; label85.Visible = false;
                label86.Visible = false; label87.Visible = false; label88.Visible = false;
                //label değerlerine isimleri atadık
                ...
                radioButton5.Visible = false;
                radioButton6.Visible = false;
             //Ülke restoranları için ortalama bütçe kullandığımız için bazı panel ve labelleri visible false yaptık
                panel8.Visible = false;
                panel9.Visible = false;
                panel10.Visible = false;
                panel11.Visible = false;
                ...
                label75.Visible = false; label76.Visible = false; label77.Visible = false;
                label78.Visible = false; label79.Visible = false; label68.Visible = false; label43.Visible = false;
             //1.restoranın isimlerini ve bulundukları bölgeleri atadık
                restoran.Yad = radioButton8.Text;
                radioButton8.Text = "Under";
                restoran.Ybolge = label9.Text;
                label9.Text = "Lindesnes";
           //restoran fiyatını labela yazdırdık 
                restoran.YFiyati = Convert.ToInt32(textBox2.Text);
                label2.Text = "2200";
                x = Convert.ToInt32(label2.Text);
           //bütçe yazan label renklerini ve görünümlerini ayarladık 
                label2.BackColor = Color.Firebrick;
                label2.ForeColor = Color.White;
                label2.BorderStyle = BorderStyle.Fixed3D;
                label66.Text = x.ToString();
           //2.restoranın isimlerini ve bulundukları bölgeleri atadık
                restoran.Yad = radioButton9.Text;
             ...
             //bütçe yazan label renklerini ve görünümlerini ayarladık 
                ...
                label19.ForeColor = Color.White;
                label19.BorderStyle = BorderStyle.Fixed3D;
             //3.restoranın isimlerini ve bulundukları bölgeleri atadık
                restoran.Yad = radioButton10.Text;
             ...
             //bütçe yazan label renklerini ve görünümlerini ayarladık 
                ...
                label30.ForeColor = Color.White;
                label30.BorderStyle = BorderStyle.Fixed3D;
             //4.restoranın isimlerini ve bulundukları bölgeleri atadık
                restoran.Yad = radioButton11.Text;
             ...
             //bütçe yazan label renklerini ve görünümlerini ayarladık 
                ...
                m = Convert.ToInt32(label40.Text);
                label40.Text = m.ToString();
             //5.restoranın isimlerini ve bulundukları bölgeleri atadık
                restoran.Yad = radioButton12.Text;
             ...
             //restoran fiyatını labela yazdırdık
                ...
                k = Convert.ToInt32(label54.Text);
                label54.Text = k.ToString();
             //6.restoranın isimlerini ve bulundukları bölgeleri atadık
                restoran.Yad = radioButton13.Text;
             //bütçe yazan label renklerini ve görünümlerini ayarladık 
                label54.BackColor = Color.Firebrick;
                label54.ForeColor = Color.White;
        ...
        {
            restoranSehir il = new restoranSehir();
            if (Atama.isim == "Antalya")
        ...
        {
            // button3 yardımıyla yapılan seçimler temizlenir.Form eski halini alır.
            label51.Text = " ";
            textBox1.Text = " ";
            textBox2.Text = " ";
            panel2.Enabled = true;
        ...
        {
            //button1 yardımıyla Odeme formuna geçiş yapılır.
            this.Hide();
            odeme.Show();
        }
        ...
        //total toplam fonk. eklemek oluşturduk
        Atama r = new Şehirler();
        private void button2_Click(object sender, EventArgs e)
        {   //kişi sayısı ve toplam tutar gönderildi
            sepet.Add(r);

            Sepet.kisisayisirestoran = textBox2.Text;
            admingiris2.restorankisi = textBox2.Text;
          // Sepet classına toplam fiyat gönderildi
            Sepet.restorantoplam = label51.Text;
            r.Fiyat = Convert.ToInt32(label51.Text);
            admingiris2.restorantoplami = label51.Text;
        ...
        { //sepet classına restoran ismini gönderir
            Sepet.restoranisim = radioButton1.Text;
         
            restoranSehir bilgi = new restoranSehir();
            //restoranSehir classından ürettiğimiz bilgi nesnesi ile fiyat değerini önceden tanımladığımız değerlere atarız
            bilgi.YFiyati = a;
            Sepet.günlükfiyatrestoran = a.ToString();
            //girilen kişi sayısı sayı değerine çevrilir
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            //label51'e toplam değeri atarız
            label51.Text = bilgi.Hesap().ToString();
        ...
        {
            Sepet.restoranisim = radioButton2.Text;
            
            restoranSehir bilgi = new restoranSehir();
          
            bilgi.YFiyati = b;
            Sepet.günlükfiyatrestoran = b.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
         }
        ...
        {
            Sepet.restoranisim = radioButton3.Text;
           

            restoranSehir bilgi = new restoranSehir();

            bilgi.YFiyati = c;
            Sepet.günlükfiyatrestoran = c.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Sepet.restoranisim = radioButton4.Text;
           ...
           restoranSehir bilgi = new restoranSehir();
            ...
            bilgi.YFiyati = d;
            Sepet.günlükfiyatrestoran = d.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Sepet.restoranisim = radioButton5.Text;
           

            restoranSehir bilgi = new restoranSehir();

            bilgi.YFiyati = f;
            Sepet.günlükfiyatrestoran = f.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Sepet.restoranisim = radioButton6.Text;
            

            restoranSehir bilgi = new restoranSehir();

            bilgi.YFiyati = g;
            Sepet.günlükfiyatrestoran = g.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Sepet.restoranisim = radioButton8.Text;

            restoranSehir bilgi = new restoranSehir();

            bilgi.YFiyati = x;
            Sepet.günlükfiyatrestoran = x.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Sepet.restoranisim = radioButton9.Text;

            restoranSehir bilgi = new restoranSehir();

            bilgi.YFiyati = s;
            Sepet.günlükfiyatrestoran = s.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Sepet.restoranisim = radioButton10.Text;

            restoranSehir bilgi = new restoranSehir();

            bilgi.YFiyati =h;
            Sepet.günlükfiyatrestoran = h.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Sepet.restoranisim = radioButton11.Text;

            restoranSehir bilgi = new restoranSehir();

            bilgi.YFiyati = m;
            Sepet.günlükfiyatrestoran = m.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Sepet.restoranisim = radioButton12.Text;

            restoranSehir bilgi = new restoranSehir();

            bilgi.YFiyati =k;
            Sepet.günlükfiyatrestoran = k.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
        ...
        {
            Sepet.restoranisim = radioButton13.Text;

            restoranSehir bilgi = new restoranSehir();

            bilgi.YFiyati = l;
            Sepet.günlükfiyatrestoran = l.ToString();
            bilgi.YAdeti = Convert.ToInt32(textBox2.Text);
            label51.Text = bilgi.Hesap().ToString();
        }
