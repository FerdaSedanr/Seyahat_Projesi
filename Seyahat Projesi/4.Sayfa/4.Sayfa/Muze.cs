...
namespace _4.Sayfa
{
    public partial class Muze : Form
    {
        ...
        Atama atama = new MuzeSehir();
        MuzeSehir muzeSehir = new MuzeSehir();
        ...
        public void Form1_Load(object sender, EventArgs e)
        {
            ...
            //MuzeSehir classından Form'un bilgilerini aldık.
            label1.Text = Atama.isim;
            ...
            {
                label47.Text = "HOŞGELDİN " + GırısAtama.kullanıcı ;
                label47.ForeColor = Color.SeaGreen;
            }
            // Sepet nesnesinin içerisindeki atama listesine eklemek için kullandığımız
            // fonksiyona muzeSehir nesnesini göderiyoruz.
            sepet.Add(muzeSehir);


            // Form için genel olarak gerekli resimleri aldık ve resmin boyutunu ayarladık. 
            ...
            // Ifler ile seçilen şehirin özel bilgilerini çağırdık.
            if (Atama.isim == "Nevşehir")
            {
                ...
                //RadioButtonun ismini MuzeSehir classındaki enumdan aldık.
                ...
                {
                    // MuzeSehir classında kayıtlı olan bilgileri Kayıt metodu içerisinden çağırdık.
                    // Devamında elde edilen fiyat bilgisini önce gerekli labela devamında ComboBox
                    // içerisine atadık.
                    ...
                    // ComboBox içerisinde tekrar eden değerleri çıkardık.
                ...
                // Nevşehir için gerekli olan resimleri ekledik.
            ...
            {
                // Rezervasyon bilgilerine eklemek için 
                // Atama classındaki parabirimi bilgisini ilettik.
                sepet.birim = atama.x;
                ...
                // İstanbul için gerekli olan resimleri ekledik.
            ...
            else if (Atama.isim == "Antalya")
            {
                ...
                // Antalya için gerekli olan resimleri ekledik.
            ...
            else if (Atama.isim == "Mardin")
            {
                ...
                foreach (var prd in sepet.GetAtama())
                {
                    // MuzeSehir classında kayıtlı olan bilgileri Kayıt metodu içerisinden çağırdım.
                    // Devamında elde edilen fiyat bilgisini önce gerekli labela devamında ComboBox
                    // içerisine atadık.
                ...
                // Mardin için gerekli olan resimleri ekledik.
            ...
            else if (Atama.isim == "Trabzon")
            {
                ...
                // Trabzon için gerekli olan resimleri ekledik.
            ...
            else if (Atama.isim == "Ankara")
            {
               ...
               sepet.birim = atama.x;
                ...
                // Ankara için gerekli olan resimleri ekledik.
            ...
            else if (Atama.isim == "Almanya")
            {
                ...
                foreach (var prd in sepet.GetAtama())
                {
                    ...
                    // ComboBox içerisinde tekrar eden değerleri çıkardım.
                    string[] items = comboBox2.Items.OfType<string>().Distinct().ToArray();
                    comboBox2.Items.Clear();
                    for (int i = 0; i < items.Length; i++)
                        comboBox2.Items.Add(items[i]);
                ...
                // Almanya için gerekli olan resimleri ekledik.
            ...
            else if (Atama.isim == "İtalya")
            {
                ...
                // İtalya için gerekli olan resimleri ekledik.
            ...
            else if (Atama.isim == "Arjantin")
            {
                ...
                // Arjantin için gerekli olan resimleri ekledik.
            ...
            else if (Atama.isim == "Japonya")
            {
               ...
               sepet.birim = atama.k;
                ...
                // Japonya için gerekli olan resimleri ekledik.
            ...
            else if (Atama.isim == "Norveç")
            {
                ...
                // Norveç için gerekli olan resimleri ekledik.
        ...
        // Seçilen Değerleri Sıralamak için oluşturduk.
        private void button1_Click(object sender, EventArgs e)
        {
          
            // Fiyat bilgilerini MuzeSehir classından alıp buraya atadık.
            int c;
            int[] fyt;
            fyt = muzeSehir.fyt;

            // For döngüleri ile Seçilen fiyat ile eşleşen panellerin renklerini belirginleştirdik
            // ve yazılarını netleştirdik.
            for (int b = 0; b < 17; b++)
            {
                c = fyt[b];
        ...
        // Yapılan işlemleri sıfırlamak için oluşturldu. 
        ...
        // Odeme formuna ulaşmak için nesne oluşturuldu.
        Odeme odeme = new Odeme();


        // Yapılan tüm seçimleri Sepet Classına kaydettik 
        // ve gerekli kısımları Odeme formuna ilettik. 
        private void button3_Click(object sender, EventArgs e)
        {
            // Odeme Formuna kişi sayısı gönderildi.
            Sepet.kisisayisimüze = textBox1.Text;
            admingiris2.muzekisi = textBox1.Text;



            // İfler ile yapılan seçim Sepet sınıfına kaydedildi.
            if (radioButton3.Checked)
            {
                ...
                Sepet.günlükfiyatmüze = muzeSehir.Fiyat.ToString();
            ...
            Sepet.müzeisim = muzeSehir.muzeismi;
            muzeSehir.Hesap();
            Sepet.müzetoplam = muzeSehir.toplam.ToString();
            //Müze seçimlerine göre hesaplanan toplamı en üst class olan Atama sınıfındaki Fiyat değişkenine atadık.
            admingiris2.muzetoplami = muzeSehir.toplam.ToString();
