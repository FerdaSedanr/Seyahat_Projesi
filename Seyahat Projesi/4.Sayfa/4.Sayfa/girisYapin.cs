...
namespace _4.Sayfa
{
    public partial class girisYapin : Form
    {
        ...
        //kullanılan ikonlar, kullanıcı adı-şifre kısmının temizlenmesi
        ...
        //veritabanından kayıt bilgilerini çekmek-karşılaştırmak
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //kallaniciadi oluşturulan veritabanındaki kullanıcı adı sütünu.
                //sifre veritabanındaki şifre sütünu. 
                //textBox1 Formdaki Kullanıcı adı yazılan textbox adı.
                //textBox2 Formdaki parola yazılan textbox adı.
                ...
                if (oku.Read())
                {
                    // Eğer kullanıcı adı ve şifre doğru girildiyse kullanıcıya ait 
                    //kullanıcıya ait eposta ve telefon numarası değişkenlere atılır
                    //Ardından giriş yapan kişinin bilgileri classta tutulur.
                    mail = oku[1].ToString();
                    tel = oku[3].ToString();
            ...
            {
                //Yanlış giriş olması durumunda çıkacak mesaj:
