...
namespace _4.Sayfa
{
    // Muze Formu içerisindeki bütün müzelerin isimlerini enum ile kaydettik.
    ...
    // Atama Sınıfından miras alan MuzeSehir classını oluşturduk.
    // Bu class Müze ilgili tüm bilgileri tutuyor. 
    public class MuzeSehir : Atama
    {
        //Form için gerekli bilgiler burda tutuluyor. 
        ...
        //Kayıt metodunu Müzelerin isimleri ile fiyat bilgilerini eşleştirmek için oluşturduk.
        public void Kayıt(MuzeIsmi isim)
        {
            // Bilgileri eşleştirmek için switch-case blokları kurduk.
        ...
        // Formda seçilen bilgileri kayıt etmek için classa atıyor.  
        ...
        // Bu classa gelen bilgileri alarak Müze son fiyatını hesaplıyor. 
