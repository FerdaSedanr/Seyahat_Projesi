...
using System.IO; //Dosya işlemleri için kütüphane ekledik.
using System.Text; //txt için kütüphane
...
namespace _4.Sayfa
{
    public partial class admingiris2 : Form
    {
        ...
        //adminSehir classındaki textleri gir nesnesi ile bu forma alıyoruz.
        ...
        private void admingiris2_Load(object sender, EventArgs e)
        {
            ...
            //pictureboxa dosyadan png ataması:
            pictureBox1.ImageLocation = "logo1.png";
            pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;


            //adminSehir classından aldığımız textleri labellara atadık:
            label1.Text = gir.lx1;
            label2.Text = gir.lx2;

            //admin.txt oluşturup içine belirtilen yazıları kaydettik.
            ...
            //oluşturduğumuz admin.txt dosyasını okutup değişkene atarız.
            string oku = File.ReadAllText("admin.txt");
            //admin.txt içindeki yazıları richtextbox ile formda gösteririz.
